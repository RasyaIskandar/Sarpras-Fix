<x-guest-layout>
    <div class="w-full h-full flex relative overflow-hidden rounded-3xl shadow-lg bg-no-repeat bg-cover bg-neutral-100" style="background-image: url('/images/wave-7.svg');">
        ...
        <div class="flex w-full md:w-1/2 text-black sm:text-neutral-200 items-center justify-center px-6 py-10 relative z-10">
            <div class="w-full max-w-md">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <!-- Button -->
                    <x-primary-button class="w-full bg-blue-600 hover:bg-blue-500 text-white font-semibold py-3 rounded-lg transition">
                        {{ __('Login') }}
                    </x-primary-button>
